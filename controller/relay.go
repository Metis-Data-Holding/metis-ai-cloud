...
func executeTaskSubmissionWith(
	...
	immediateTerminal := task.PrivateData.SuperResolution == nil && result.Immediate != nil && (result.Immediate.Status == model.TaskStatusSuccess || result.Immediate.Status == model.TaskStatusFailure)
