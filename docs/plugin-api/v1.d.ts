...
export interface PrepareRequestDescriptor {url: string; method?: "GET" | "HEAD" | "POST"; headers?: Record<string, string>; body?: unknown; bodyType?: "multipart"; parts?: readonly {name: string; value?: unknown; fileRef?: string; filename?: string}[]}
export interface RequestDescriptor {responseType?: "json" | "sse"; url: string; method?: string; headers?: Record<string, string>; /** JSON body may contain FilePlaceholder objects at any depth; the host replaces each with a Base64 or data-URL string. */ body?: unknown; credentialless?: boolean; action?: string; model?: string; rewriteModel?: string; bodyType?: "json" | "multipart"; parts?: readonly {name: string; value?: unknown; fileRef?: string; filename?: string}[]; prepareRequest?: PrepareRequestDescriptor; prepareRequests?: readonly PrepareRequestDescriptor[]}
